...
import CreditNote from "../feature-module/sales/CreditNote";

const DebitNote = lazy(() => import("../feature-module/purchases/DebitNote"));
...
const Signin = lazy(() =>
  import("../feature-module/pages/authentication/login/signin")
);
const SigninTwo = lazy(() =>
  import("../feature-module/pages/authentication/login/signinTwo")
);
...
const ForgotpasswordTwo = lazy(() =>
  import(
    "../feature-module/pages/authentication/forgotpassword/forgotpasswordTwo"
  )
);
const ForgotpasswordThree = lazy(() =>
  import(
    "../feature-module/pages/authentication/forgotpassword/forgotpasswordThree"
  )
);
...
const ResetpasswordTwo = lazy(() =>
  import(
    "../feature-module/pages/authentication/resetpassword/resetpasswordTwo"
  )
);
const ResetpasswordThree = lazy(() =>
  import(
    "../feature-module/pages/authentication/resetpassword/resetpasswordThree"
  )
);
const EmailVerification = lazy(() =>
  import(
    "../feature-module/pages/authentication/emailverification/emailverification"
  )
);
const EmailverificationTwo = lazy(() =>
  import(
    "../feature-module/pages/authentication/emailverification/emailverificationTwo"
  )
);
const EmailverificationThree = lazy(() =>
  import(
    "../feature-module/pages/authentication/emailverification/emailverificationThree"
  )
);
const Twostepverification = lazy(() =>
  import(
    "../feature-module/pages/authentication/twostepverification/twostepverification"
  )
);
const TwostepverificationTwo = lazy(() =>
  import(
    "../feature-module/pages/authentication/twostepverification/twostepverificationTwo"
  )
);
...
const Success = lazy(() =>
  import("../feature-module/pages/authentication/success/success")
);
...
const LayoutDemo = lazy(() => import("../components/layouts/layoutdemo"));
...
const ButtonsGroup = lazy(() =>
  import("../feature-module/uiinterface/buttonsgroup")
);
const Breadcrumb = lazy(() =>
  import("../feature-module/uiinterface/breadcrumb")
);
...
const Pagination = lazy(() =>
  import("../feature-module/uiinterface/pagination")
);
const Placeholder = lazy(() =>
  import("../feature-module/uiinterface/placeholder")
);
const Progess = lazy(() => import("../feature-module/uiinterface/progress"));
const RangeSlides = lazy(() =>
  import("../feature-module/uiinterface/rangeslider")
);
...
const Typography = lazy(() =>
  import("../feature-module/uiinterface/typography")
);
const Video = lazy(() => import("../feature-module/uiinterface/video"));
const ClipBoard = lazy(() =>
  import("../feature-module/uiinterface/advancedui/clipboard")
);
const Counter = lazy(() =>
  import("../feature-module/uiinterface/advancedui/counter")
);
const DragDrop = lazy(() =>
  import("../feature-module/uiinterface/advancedui/dragdrop")
);
const Rating = lazy(() =>
  import("../feature-module/uiinterface/advancedui/rating")
);
const Ribbon = lazy(() =>
  import("../feature-module/uiinterface/advancedui/ribbon")
);
const TextEditor = lazy(() =>
  import("../feature-module/uiinterface/advancedui/texteditor")
);
const Timeline = lazy(() =>
  import("../feature-module/uiinterface/advancedui/timeline")
);

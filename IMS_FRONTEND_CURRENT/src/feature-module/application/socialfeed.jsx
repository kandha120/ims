              ...
              <div>
                  ...
                  <div className="card-body">
                    ...
                    >
                      ...
                      <Link
                        ...
                        className="gallery-item"
                      >
                        <img src={gallery02} className="rounded" alt="img" />
                      ...
                      <Link
                        ...
                        className="gallery-item"
                      >
                        <img src={gallery03} className="rounded" alt="img" />
                      ...
                      <Link
                        ...
                        className="gallery-item"
                      >
                        <img src={gallery04} className="rounded" alt="img" />
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="mb-2">
                      <img src={socialFeed03} className="rounded" alt="Img" />
                    </div>
                    <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                      <div className="d-flex align-items-center flex-wrap row-gap-3">
                        <Link

    ...
    <div>
      <div className="page-wrapper">
        <div className="content">
          ...
          <div className="card">
            <div className="card-body">
              <h5 className="mb-3">Search result for {`" iatsolutionsPOS"`}</h5>
              <div className="row">
                <div className="col-md-6">
                  <div className="card shadow-none">
                    <div className="card-body">
                      <Link to="#" className="text-info text-truncate mb-2">
                        https://themeforest.net/search/ iatsolutionspos
                      </Link>
                      <p className="text-truncate line-clamb-2 mb-2">
                        iatsolutionsPOS - Html, Vue 3, Angular 17+, React &amp;
                        Node HR Project Management &amp; CRM Admin Dashboard
                        Template
                      </p>

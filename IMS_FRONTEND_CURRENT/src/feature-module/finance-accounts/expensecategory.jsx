...
const ExpenseCategory = () => {
  ...
  const handleExportPDF = () => {
    const doc = new jsPDF();
    doc.text("Expense Category List", 14, 22);

    const tableColumn = ["Category Name", "Description", "Status"];
    ...
    doc.save("ExpenseCategoryList.pdf");
  };
  ...
  const handleExportExcel = () => {
    ...
    link.setAttribute("download", "ExpenseCategoryList.csv");
